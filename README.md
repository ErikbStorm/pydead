...
<p align="center">
  <img src="docs/images/cli-find.svg" alt="Colorful terminal: pydead find reporting DC001–DC004 findings" width="920" />
</p>

<p align="center">
  <img src="docs/images/vscode-diag.svg" alt="VS Code showing PyDead unused-code highlights, Problems panel, and status bar" width="920" />
</p>

<p align="center">
  <img src="docs/images/vscode-quickfix.svg" alt="VS Code Quick Fix: keep, report false positive, or remove unused code" width="700" />
</p>

> Visuals are **SVG mockups** generated by `python3 scripts/generate_readme_assets.py` (exact text, regeneratable — no screenshot capture).
